...
from packetping.constant.training_pipeline import TRAINING_BUCKET_NAME
from packetping.cloud.s3_syncer import S3Sync

from packetping.entity.config_entity import (
...
from packetping.entity.artifact_entity import (
...
class TrainingPipeline:
    ...
    # Local Artifact is goning to s3 bucket
